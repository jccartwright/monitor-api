...
include::{snippets}/healthChecks-create-example/request-fields.adoc[]

==== Example request

include::{snippets}/healthChecks-create-example/curl-request.adoc[]

==== Example response

include::{snippets}/healthChecks-create-example/http-response.adoc[]
